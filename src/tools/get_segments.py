...
class GetSegmentsParams(BaseModel):
    """세그먼트 파라미터"""
...
class GetSegmentsTool(Tool):
    name: str = "get_segments"
    ...
    async def execute(self, params: dict) -> dict:
        ...
        try:
            # 파라미터 검증
            validated_params = GetSegmentsParams(**params)
            ...
            logger.error("세그먼트 조회 중 오류 발생: %s", str(e))
            raise
